(** [Raw] wraps a file-descriptor with an file-format used internally by Index. The format contains
    ...
    - {b fan}: a 64-bit length field, followed by a string containing that many bytes. *)
